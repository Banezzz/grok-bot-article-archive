...
const ZH = {
	...
	mine: '我的',
	addToFolders: '加入文件夹',
	addToFoldersCount: '加入文件夹 · 已选 {n}',
	folderPickerAria: '选择文件夹',
	applyFolders: '应用',
	cancel: '取消',
	saveFolders: '保存文件夹',
...
const EN: Record<MessageKey, string> = {
	...
	search: 'Search',
	sortAria: 'Sort',
	sortJoined: 'Join time',
	sortPublished: 'Article time',
	tagsAria: 'Tags',
	foldersAria: 'Folders',
	allTags: 'All',
	...
	addToFoldersCount: 'Add to folders · {n} selected',
	folderPickerAria: 'Choose folders',
	applyFolders: 'Apply',
	cancel: 'Cancel',
